...
if __name__ == "__main__":
    ...
    logging.info('Create table top_users_by_posts if not exist.')
    with open('../sql/top_users_by_posts.sql', 'r') as top_users_by_posts_file:
        script = top_users_by_posts_file.read()
        cursor.execute(script)

    logging.info('Update top_users_by_posts.')
